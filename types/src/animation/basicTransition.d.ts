import { AnimationOptionMixin, AnimationOption } from '../util/types';
import Element, { ElementAnimateConfig, ElementProps } from 'zrender/src/Element';
import Model from '../model/Model';
import Displayable from 'zrender/src/graphic/Displayable';
export declare const transitionStore: (hostObj: Displayable<import("zrender/src/graphic/Displayable").DisplayableProps>) => {
...
export declare function getOldStyle(el: Displayable): import("zrender/src/core/types").Dictionary<any>;
