...
declare class ECharts extends Eventful<ECEventDefinition> {
     ...
     */
    getVisual(finder: ModelFinder, visualType: string): string | number | number[] | import("zrender/src/graphic/Pattern").PatternObject | import("zrender/src/graphic/LinearGradient").LinearGradientObject | import("zrender/src/graphic/RadialGradient").RadialGradientObject;
    /**
