...
import { TransitionOptionMixin, TransitionBaseDuringAPI, TransitionDuringAPI } from '../../animation/customGraphicTransition';
...
export declare const customInnerStore: (hostObj: Element<import("zrender/src/Element").ElementProps>) => {
    info: CustomExtraElementInfo;
