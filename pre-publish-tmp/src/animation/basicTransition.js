...
* under the License.
*/
import { isFunction, isObject, retrieve2 } from 'zrender/src/core/util';
...
function animateOrSetProps(animationType, el, props, animatableModel, dataIndex, cb, during) {
    ...
    var animationConfig = getAnimationConfig(animationType, animatableModel, dataIndex, isRemove ? (removeOpt || {}) : null, (animatableModel && animatableModel.getAnimationDelayParams)
