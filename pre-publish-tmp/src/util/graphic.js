...
import { extend, isArrayLike, map, defaults, isString, keys, each, hasOwn, isArray } from 'zrender/src/core/util';
...
export function subPixelOptimizeLine(shape, lineWidth) {
    subPixelOptimizeUtil.subPixelOptimizeLine(shape, shape, { lineWidth: lineWidth });
    return shape;
}
/**
