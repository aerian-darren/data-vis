...
* under the License.
*/
import { each, isObject, isArray, createHashMap, map, assert, isString, indexOf, isStringSafe, isNumber } from 'zrender/src/core/util';
...
export function preParseFinder(finderInput, opt) {
    ...
    return { mainTypeSpecified: mainTypeSpecified, queryOptionMap: queryOptionMap, others: others };
}
export var SINGLE_REFERRING = { useDefault: true, enableAll: false, enableNone: false };
export var MULTIPLE_REFERRING = { useDefault: false, enableAll: true, enableNone: true };
