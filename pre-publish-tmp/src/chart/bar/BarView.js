...
import { Rect, Sector, updateProps, initProps, removeElementWithFadeOut, traverseElements } from '../../util/graphic';
...
var BarView = /** @class */ (function (_super) {
    ...
    BarView.prototype._enableRealtimeSort = function (realtimeSortCfg, data, api) {
        ...
        if (this._isFirstFrame) {
            ...
            var orderMapping_1 = function (idx) {
                ...
                Math.abs(baseAxis.isHorizontal()
                    ? shape.height
                    : shape.width)
    ...
    BarView.prototype._dataSort = function (data, baseAxis, orderMapping) {
        ...
        return {
            ordinalNumbers: map(info, function (item) { return item.ordinalNumber; })
        };
    };
    ...
    BarView.prototype._dispatchInitSort = function (data, realtimeSortCfg, api) {
        var baseAxis = realtimeSortCfg.baseAxis;
        var sortResult = this._dataSort(data, baseAxis, function (dataIdx) { return data.get(data.mapDimension(realtimeSortCfg.otherAxis.dim), dataIdx); });
        api.dispatchAction({
            type: 'changeAxisOrder',
            componentType: baseAxis.dim + 'Axis',
            isInitSort: true,
