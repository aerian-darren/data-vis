            ...
            data.diff(oldData)
                ...
                if (showPointer) {
                    ...
                    graphic.initProps(pointer, {
                        rotation: -((isNaN(+val) ? angleExtent[0] : linearMap(val, valueExtent, angleExtent, true))
                            + Math.PI / 2)
                    }, seriesModel);
                    group.add(pointer);
    ...
    GaugeView.prototype._renderTitleAndDetail = function (seriesModel, ecModel, api, getColor, posInfo) {
        ...
        data.each(function (idx) {
            ...
            if (itemDetailModel.get('show')) {
                ...
                setLabelValueAnimation(labelEl, { normal: itemDetailModel }, value, function (value) { return formatLabel(value, formatter_1); });
