...
var SeriesData = /** @class */ (function () {
    ...
    SeriesData.prototype._initGetDimensionInfo = function (needsHasOwn) {
        ...
        this._getDimInfo = needsHasOwn
            ? function (dimName) { return (dimensionInfos.hasOwnProperty(dimName) ? dimensionInfos[dimName] : undefined); }
            : function (dimName) { return dimensionInfos[dimName]; };
    };
    /**
    ...
    SeriesData.prototype.initData = function (data, nameList, dimValueGetter) {
        ...
        if (!store) {
            ...
            var provider = (isSourceInstance(data) || zrUtil.isArrayLike(data))
                ...
                : data;
            store = new DataStore();
            var dimensionInfos = map(dimensions, function (dimName) { return ({
    ...
    SeriesData.prototype.getValues = function (dimensions, idx) {
        ...
        return zrUtil.isArray(dimensions)
            ? store.getValues(map(dimensions, function (dim) { return _this._getStoreDimIndex(dim); }), idx)
