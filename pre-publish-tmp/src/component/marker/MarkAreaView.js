...
import { retrieve, mergeAll, map, curry, filter, extend, isString } from 'zrender/src/core/util';
...
var MarkAreaView = /** @class */ (function (_super) {
    ...
    MarkAreaView.prototype.renderSeries = function (seriesModel, maModel, ecModel, api) {
        ...
        areaData.each(function (idx) {
            ...
            var overlapped = !(xAxisExtent[0] > xPointExtent[1] || xAxisExtent[1] < xPointExtent[0]
...
function createList(coordSys, seriesModel, maModel) {
    ...
    if (coordSys) {
        ...
        dataDims = map(dims, function (dim, idx) { return ({
            name: dim,
