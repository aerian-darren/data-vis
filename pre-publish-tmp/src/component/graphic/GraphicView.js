...
import { applyLeaveTransition, applyUpdateTransition, isTransitionAll, updateLeaveTo } from '../../animation/customGraphicTransition';
import { updateProps } from '../../animation/basicTransition';
import { applyKeyframeAnimation, stopPreviousKeyframeAnimationAndRestore } from '../../animation/customGraphicKeyframeAnimation';
...
var GraphicComponentView = /** @class */ (function (_super) {
    ...
    GraphicComponentView.prototype._updateElements = function (graphicModel) {
        ...
        zrUtil.each(elOptionsToUpdate, function (elOption) {
            ...
            if (isMerge) {
                ...
                if (el_1) {
                    applyUpdateTransition(el_1, elOptionCleaned, graphicModel, { isInit: isInit });
            ...
            if (el) {
                ...
                if (clipPathOption) {
                    ...
                    applyUpdateTransition(clipPath, clipPathOption, graphicModel, { isInit: isInit });
    ...
    GraphicComponentView.prototype._relocate = function (graphicModel, api) {
        ...
        for (var i = elOptions.length - 1; i >= 0; i--) {
            ...
            var layoutPos = {};
            var layouted = layoutUtil.positionElement(el, elOption, containerInfo, null, { hv: elOption.hv, boundingMode: elOption.bounding }, layoutPos);
